...
export default class AnswerToQuestionPage extends Component {
    ...
    async commitOneQuestion() {
        var url = contant.SERVER_ROOT + contant.SERVER_SERVICE.INSERT_COMMENT + "?" + "nid=" + contant.USER.nid + "&" + "cid=" + this.props.cid + "&" + "content=" + this.state.contentText + "&" + "date=" + this.getNowFormatDate();
        try {
